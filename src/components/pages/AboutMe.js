    ...
    return (<>
        ...
        <div className="bg-white">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mx-auto mt-10 flex row">
        ...
        <div className="bg-white pb-16 px-16">
            ...
            <div className="carousel w-1/2 h-1/2 mx-auto">
                <div id="item1" className="carousel-item w-full h-auto object-cover">
                    <img src="../images/hiking.jpeg" className="w-full" />
                </div>
                <div id="item2" className="carousel-item w-full h-auto object-contain">
                    <img src="../images/baby.jpeg" className="w-full" />
                </div>
                <div id="item3" className="carousel-item w-full h-full object-contain">
                    <img src="../images/hawaii.jpeg" className="w-full" />
                </div>
                <div id="item4" className="carousel-item w-full h-auto object-cover">
